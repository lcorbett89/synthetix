<template>
	<header class="pb-24 bg-blue-600">
		<div class="max-w-3xl px-4 py-5 mx-auto sm:px-6 lg:max-w-7xl lg:px-8 lg:py-0">
			<div class="relative flex items-center justify-center py-5 lg:justify-between">
				...
				<div v-show="isLoggedIn" class="hidden lg:ml-4 lg:flex lg:items-center lg:pr-0.5">
			...
			<div class="hidden py-5 border-t border-white lg:block border-opacity-20">
			...
			<div class="absolute inset-x-0 top-0 z-30 w-full max-w-3xl p-2 mx-auto transition origin-top transform">
				<div class="bg-white divide-y divide-gray-200 rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
					<div class="pt-3 pb-2">
						...
						<div class="px-2 mt-3 space-y-1" @click="showDropdown = false">
							<router-link to="/jokes" class="block px-3 py-2 text-base font-medium text-gray-900 rounded-md hover:bg-gray-100 hover:text-gray-800">All Jokes</router-link>
							<router-link to="/jokes/vote" class="block px-3 py-2 text-base font-medium text-gray-900 rounded-md hover:bg-gray-100 hover:text-gray-800">Vote On Jokes</router-link>
							<router-link to="/jokes/create" class="block px-3 py-2 text-base font-medium text-gray-900 rounded-md hover:bg-gray-100 hover:text-gray-800">Add Joke</router-link>
						</div>
					</div>
					<div class="pt-4 pb-2">
						...
						<div class="px-2 mt-3 space-y-1" @click="showDropdown = false">
							<a href="#" @click="logout" class="block px-3 py-2 text-base font-medium text-gray-900 rounded-md hover:bg-gray-100 hover:text-gray-800">Sign out</a>
						</div>
					</div>
				</div>
			</div>
